...
<div class="section" style="margin-top:20px">
  ...
  <table style="width:100%">
    ...
    <tr style="border-bottom:1px solid #e2e2ea"><td style="padding:8px">导出</td><td style="padding:8px">导出成功</td><td style="padding:8px;font-family:JetBrains Mono,monospace;font-size:11px">Dialog</td><td style="padding:8px">导出完成弹窗，含文件名+词数统计+分享</td></tr>
    ...
    <div style="background:#fff;border-bottom:1px solid #e2e2ea;padding:14px 16px 12px">
      <div style="display:flex;align-items:center;justify-content:space-between;padding:0 0 14px 4px">
        <div style="display:flex;align-items:center;gap:8px">
          <img src="header-logo.png" width="28" height="28" style="border-radius:6px" alt="">
...
// ===== SPLASH SCREEN =====
const splashScreen = `background:#2f5cff;min-height:${PH}px;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:0`;

const p_splash = mockup('启动页', '启动页 · Splash', splashScreen, `
    <div style="display:flex;align-items:center;justify-content:center;width:100%;height:100%">
      <img src="splash-logo.png" width="180" height="180" style="border-radius:32px" alt="WordSnap Logo">
    </div>`);
	    ...
	    <div style="flex:1;padding:16px;display:flex;flex-direction:column;gap:12px;overflow-y:auto">
	      ...
	      <div style="background:#fff;border:1px solid #e2e2ea;border-radius:12px;padding:14px">
	        ...
	        <div style="display:flex;align-items:center;gap:8px">
	          ...
	          <span style="font-family:Inter,sans-serif;font-size:13px;color:#0b0b0f">剪贴板</span>
...
// ===== PAGE 6 =====
const achieveRow = (label, unlocked, progress) => {
  const icon = unlocked
    ? '<span style="font-size:14px;color:#00c896">✓</span>'
    : '<span style="font-size:14px;color:#ddd">○</span>';
  const nameStyle = unlocked
    ? 'font-family:Inter,sans-serif;font-size:13px;color:#0b0b0f'
    : 'font-family:Inter,sans-serif;font-size:13px;color:#bbb';
  const progHtml = !unlocked && progress
    ? '<span style="font-family:JetBrains Mono,monospace;font-size:10px;color:#ddd;margin-left:auto">' + progress + '</span>'
    : '';
  return `
	      <div style="padding:10px 14px;display:flex;align-items:center;gap:10px;border-bottom:1px solid #f0f0f5">${icon}<span style="${nameStyle}">${label}</span>${progHtml}</div>`;
};

const p6 = mockup('6', '档案卡', SCREEN, `
${headerBar('archive')}
	    <div style="flex:1;padding:14px;display:flex;flex-direction:column;gap:10px;overflow-y:auto">
	      <div style="background:#fff;border:1px solid #e2e2ea;border-radius:16px;padding:20px;text-align:center">
	        <div style="font-family:Inter,sans-serif;font-size:11px;font-weight:600;color:#999;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:8px">已掌握</div>
	        <div style="font-family:JetBrains Mono,monospace;font-size:56px;font-weight:500;color:#00c896;line-height:1">42</div>
	        <div style="font-family:Inter,sans-serif;font-size:13px;color:#999;margin-top:4px">个单词</div>
	        <div style="display:flex;justify-content:space-around;margin-top:16px;padding-top:14px;border-top:1px solid #f0f0f5">
	          <div style="text-align:center">
	            <div style="font-family:Inter,sans-serif;font-size:10px;color:#bbb">首次学习</div>
	            <div style="font-family:JetBrains Mono,monospace;font-size:13px;color:#0b0b0f;margin-top:2px">2026/5/1</div>
	          </div>
	          <div style="text-align:center">
	            <div style="font-family:Inter,sans-serif;font-size:10px;color:#bbb">学习天数</div>
	            <div style="font-family:JetBrains Mono,monospace;font-size:13px;color:#0b0b0f;margin-top:2px">12 天</div>
	          </div>
	          <div style="text-align:center">
	            <div style="font-family:Inter,sans-serif;font-size:10px;color:#bbb">复习总次数</div>
	            <div style="font-family:JetBrains Mono,monospace;font-size:13px;color:#0b0b0f;margin-top:2px">328</div>
	          </div>
	        </div>
	      </div>
	      <div style="display:flex;gap:8px">
	        <div style="flex:1;background:#fff;border:1px solid #e2e2ea;border-radius:12px;padding:12px;text-align:center">
	          <div style="font-family:JetBrains Mono,monospace;font-size:20px;color:#0b0b0f">89</div>
	          <div style="font-family:Inter,sans-serif;font-size:10px;color:#999;margin-top:2px">词汇总量</div>
	        </div>
	        <div style="flex:1;background:#fff;border:1px solid #e2e2ea;border-radius:12px;padding:12px;text-align:center">
	          <div style="font-family:JetBrains Mono,monospace;font-size:20px;color:#ffa940">47</div>
	          <div style="font-family:Inter,sans-serif;font-size:10px;color:#999;margin-top:2px">复习中</div>
	        </div>
	        <div style="flex:1;background:#fff;border:1px solid #e2e2ea;border-radius:12px;padding:12px;text-align:center">
	          <div style="font-family:JetBrains Mono,monospace;font-size:20px;color:#7068f0">3</div>
	          <div style="font-family:Inter,sans-serif;font-size:10px;color:#999;margin-top:2px">单词本</div>
	        </div>
	      </div>
	      <div style="font-family:Inter,sans-serif;font-size:10px;font-weight:600;color:#999;text-transform:uppercase;letter-spacing:0.05em;margin-top:4px">成就</div>
	      <div style="background:#fff;border:1px solid #e2e2ea;border-radius:12px;overflow:hidden">
${achieveRow('掌握 10 词', true)}
${achieveRow('掌握 100 词', false, '42/100')}
${achieveRow('掌握 1000 词', false, '42/1000')}
${achieveRow('掌握 5000 词', false, '42/5000')}
${achieveRow('连续学习 7 天', true)}
${achieveRow('连续学习 30 天', false, '12/30')}
${achieveRow('连续学习 90 天', false, '12/90')}
${achieveRow('连续学习 180 天', false, '12/180')}
${achieveRow('创建 3 个单词本', false, '1/3')}
${achieveRow('创建 10 个单词本', false, '1/10')}
	      </div>
	    </div>
${bottomPill()}`);
...
// Reusable settings page content (used by overlay dialogs)
const settingsInner = `
    <div style="background:#fff;border-bottom:1px solid #e2e2ea;padding:12px 14px;display:flex;align-items:center;gap:12px">
      <span style="font-size:18px;color:#0b0b0f;cursor:pointer">&larr;</span>
      <span style="font-family:Inter,sans-serif;font-size:15px;font-weight:600;color:#0b0b0f">设置</span>
...
// ===== PAGE 7-export =====
const p7_export = mockup('7-导出', '导出成功', SCREEN+';position:relative', `
${settingsInner}
    <div style="position:absolute;inset:0;background:rgba(0,0,0,0.3);display:flex;align-items:center;justify-content:center">
      <div style="background:#fff;border-radius:16px;padding:24px 20px 20px;width:300px;text-align:center;display:flex;flex-direction:column;gap:12px;box-shadow:0 8px 32px rgba(0,0,0,0.12)">
        <div style="width:48px;height:48px;border-radius:50%;background:#00c896;display:flex;align-items:center;justify-content:center;margin:0 auto">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>
        </div>
        <div style="font-family:Inter,sans-serif;font-size:17px;font-weight:600;color:#0b0b0f">导出成功</div>
        <div style="background:#f9f9fb;border-radius:10px;padding:12px">
          <div style="font-family:JetBrains Mono,monospace;font-size:11px;color:#0b0b0f;word-break:break-all">wordsnap_backup_2026-05-07.json</div>
          <div style="font-family:Inter,sans-serif;font-size:11px;color:#999;margin-top:6px">89 词 &middot; 3 个单词本</div>
        </div>
        <div style="display:flex;gap:10px">
          <button style="flex:1;padding:12px;border:1px solid #e2e2ea;border-radius:100px;background:#fff;font-family:Inter,sans-serif;font-size:13px;color:#0b0b0f">分享文件</button>
          <button style="flex:1;padding:12px;border:none;border-radius:100px;background:#2f5cff;font-family:Inter,sans-serif;font-size:13px;color:#fff;font-weight:500">完成</button>
        </div>
      </div>
    </div>`);


// ===== PAGE 7-import-preview =====
const p7_import_preview = mockup('7-导入预览', '导入预览', SCREEN+';position:relative', `
${settingsInner}
    <div style="position:absolute;inset:0;background:rgba(0,0,0,0.3);display:flex;align-items:center;justify-content:center">
      <div style="background:#fff;border-radius:16px;padding:20px;width:310px;display:flex;flex-direction:column;gap:14px;box-shadow:0 8px 32px rgba(0,0,0,0.12)">
        <div style="font-family:Inter,sans-serif;font-size:17px;font-weight:600;color:#0b0b0f;text-align:center">导入预览</div>
        <div style="display:flex;justify-content:space-around;text-align:center">
          <div>
            <div style="font-family:JetBrains Mono,monospace;font-size:22px;color:#0b0b0f">3</div>
            <div style="font-family:Inter,sans-serif;font-size:10px;color:#999;margin-top:2px">单词本</div>
          </div>
          <div>
            <div style="font-family:JetBrains Mono,monospace;font-size:22px;color:#00c896">47</div>
            <div style="font-family:Inter,sans-serif;font-size:10px;color:#999;margin-top:2px">新增词</div>
          </div>
          <div>
            <div style="font-family:JetBrains Mono,monospace;font-size:22px;color:#bbb">12</div>
            <div style="font-family:Inter,sans-serif;font-size:10px;color:#999;margin-top:2px">已存在</div>
          </div>
        </div>
        <div style="background:#f9f9fb;border-radius:10px;padding:10px 12px;max-height:120px;overflow-y:auto">
          <div style="display:flex;align-items:center;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f0f0f5">
            <span style="font-family:Inter,sans-serif;font-size:12px;color:#0b0b0f">&#x1F4D6; 拾词集</span>
            <span style="font-family:Inter,sans-serif;font-size:10px;color:#999">35词 &middot; 已存在</span>
          </div>
          <div style="display:flex;align-items:center;justify-content:space-between;padding:6px 0;border-bottom:1px solid #f0f0f5">
            <span style="font-family:Inter,sans-serif;font-size:12px;color:#0b0b0f">&#x1F4D6; GRE 核心词汇</span>
            <span style="font-family:Inter,sans-serif;font-size:10px;color:#999">32词 &middot; 已存在</span>
          </div>
          <div style="display:flex;align-items:center;justify-content:space-between;padding:6px 0;">
            <span style="font-family:Inter,sans-serif;font-size:12px;color:#0b0b0f">&#x1F4D6; 医学英语</span>
            <span style="font-family:Inter,sans-serif;font-size:10px;color:#00c896">20词 &middot; 新增</span>
          </div>
        </div>
        <div style="font-family:Inter,sans-serif;font-size:10px;color:#bbb;text-align:center">导入规则：同名单词本合并，同词去重</div>
        <div style="display:flex;gap:10px">
          <button style="flex:1;padding:12px;border:1px solid #e2e2ea;border-radius:100px;background:#fff;font-family:Inter,sans-serif;font-size:13px;color:#999">取消</button>
          <button style="flex:1;padding:12px;border:none;border-radius:100px;background:#2f5cff;font-family:Inter,sans-serif;font-size:13px;color:#fff;font-weight:500">确认导入</button>
        </div>
      </div>
    </div>`);
...
// ===== PAGE 7-import-done =====
const p7_import_done = mockup('7-导入完成', '导入完成', SCREEN+';position:relative', `
${settingsInner}
    <div style="position:absolute;inset:0;background:rgba(0,0,0,0.3);display:flex;align-items:center;justify-content:center">
      <div style="background:#fff;border-radius:16px;padding:24px 20px 20px;width:300px;text-align:center;display:flex;flex-direction:column;gap:12px;box-shadow:0 8px 32px rgba(0,0,0,0.12)">
        <div style="width:48px;height:48px;border-radius:50%;background:#00c896;display:flex;align-items:center;justify-content:center;margin:0 auto">
        ...
        <div style="font-family:Inter,sans-serif;font-size:17px;font-weight:600;color:#0b0b0f">导入完成</div>
        <div style="font-family:Inter,sans-serif;font-size:13px;color:#999;line-height:1.6">新增 <span style="color:#00c896;font-weight:600">47</span> 词，合并 <span style="color:#2f5cff;font-weight:600">2</span> 个单词本</div>
        <button style="width:100%;padding:12px;border:none;border-radius:100px;background:#2f5cff;font-family:Inter,sans-serif;font-size:13px;color:#fff;font-weight:500;margin-top:4px">完成</button>
      </div>
    </div>`);


// ===== PAGE 8a =====
const p8a = mockup('8a', '手动输入', SCREEN+';position:relative', `
    <div style="flex:1;background:rgba(0,0,0,0.15);display:flex;align-items:flex-end">
      <div style="background:#fff;border-radius:18px 18px 0 0;width:100%;padding:18px 18px 22px;display:flex;flex-direction:column;gap:14px;max-height:90%;overflow-y:auto">
        <div style="width:30px;height:4px;border-radius:2px;background:#ddd;margin:0 auto -4px"></div>
        <div style="font-family:Inter,sans-serif;font-size:16px;font-weight:600;color:#0b0b0f;text-align:center">输入单词</div>
        <div style="background:#f9f9fb;border:1px solid #e2e2ea;border-radius:14px;padding:18px;text-align:center">
          <div style="font-family:Source Serif 4,serif;font-size:24px;color:#bbb;min-height:32px">输入英文单词...</div>
        </div>
        <div style="font-family:Inter,sans-serif;font-size:10px;font-weight:600;color:#999;text-transform:uppercase;letter-spacing:0.05em">查询结果</div>
        <div style="background:#fff;border:1px solid #e2e2ea;border-radius:14px;padding:16px">
          ...
          <div style="font-family:Inter,sans-serif;font-size:12px;color:#0b0b0f;line-height:1.8">
            1. 短暂的，转瞬即逝的<br>
            2. 朝生暮死的（生物）
          </div>
        </div>
        ...
        <div style="display:flex;gap:10px">
          <button style="flex:1;padding:12px;border:1px solid #e2e2ea;border-radius:100px;background:#fff;font-family:Inter,sans-serif;font-size:13px;color:#999">取消</button>
          <button style="flex:1;padding:12px;border:none;border-radius:100px;background:#2f5cff;font-family:Inter,sans-serif;font-size:13px;color:#fff;font-weight:500">确认添加</button>
        </div>
      </div>
    </div>`);

// ===== PAGE 8b =====
const p8b = mockup('8b', '拍照识别', SCREEN, `
    <div style="background:#fff;border-bottom:1px solid #e2e2ea;padding:10px 14px;display:flex;align-items:center;gap:10px">
      <span style="font-size:18px;color:#0b0b0f;cursor:pointer">&larr;</span>
      <span style="font-family:Inter,sans-serif;font-size:15px;font-weight:600;color:#0b0b0f">拍照识别</span>
    </div>
    <div style="flex:1;display:flex;flex-direction:column">
      <!-- Camera preview -->
      <div style="background:#1a1a2e;height:200px;display:flex;align-items:center;justify-content:center;position:relative">
        <div style="text-align:center">
          <div style="width:56px;height:56px;border-radius:50%;border:3px solid #fff;display:flex;align-items:center;justify-content:center;margin:0 auto">
            <div style="width:44px;height:44px;border-radius:50%;background:#fff"></div>
          </div>
          <div style="font-family:Inter,sans-serif;font-size:10px;color:rgba(255,255,255,0.5);margin-top:8px">轻触拍照</div>
        </div>
        <!-- Flash + gallery icons top-right -->
        <div style="position:absolute;top:10px;right:12px;display:flex;gap:8px">
          <div style="width:28px;height:28px;border-radius:50%;background:rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.5"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
          </div>
        </div>
      </div>
      <!-- OCR results -->
      <div style="flex:1;padding:16px;display:flex;flex-direction:column;gap:12px;overflow-y:auto">
        <div style="font-family:Inter,sans-serif;font-size:10px;font-weight:600;color:#999;text-transform:uppercase;letter-spacing:0.05em">识别到 4 个单词 · 点选添加</div>
        <div style="display:flex;flex-wrap:wrap;gap:8px">
          <div style="padding:10px 16px;border-radius:100px;background:#2f5cff;font-family:Source Serif 4,serif;font-size:15px;color:#fff;font-weight:600">ephemeral <span style="font-size:10px;opacity:0.7;margin-left:2px">✓</span></div>
          <div style="padding:10px 16px;border-radius:100px;background:#f0f0f5;font-family:Source Serif 4,serif;font-size:15px;color:#0b0b0f;font-weight:600">ubiquitous</div>
          <div style="padding:10px 16px;border-radius:100px;background:#2f5cff;font-family:Source Serif 4,serif;font-size:15px;color:#fff;font-weight:600">serendipity <span style="font-size:10px;opacity:0.7;margin-left:2px">✓</span></div>
          <div style="padding:10px 16px;border-radius:100px;background:#f0f0f5;font-family:Source Serif 4,serif;font-size:15px;color:#0b0b0f;font-weight:600">eloquent</div>
        </div>
        <div style="display:flex;align-items:center;justify-content:center;gap:8px;background:#f9f9fb;border-radius:10px;padding:10px 14px">
          <span style="font-family:Inter,sans-serif;font-size:12px;color:#999">存入</span>
          <span style="font-family:Inter,sans-serif;font-size:12px;font-weight:600;color:#0b0b0f">拾词集</span>
        ...
        <button style="padding:14px;border:none;border-radius:100px;background:#2f5cff;font-family:Inter,sans-serif;font-size:15px;color:#fff;font-weight:600">添加选中词 (2)</button>
      </div>
    </div>`);
...
// ===== ASSEMBLE =====
const allMockups = [p_splash, p1, p2, p3a, p3b, p4, p4b, p5, p5b, p6, p7, p7_export, p7_import_preview, p7_import_done, p8a, p8b, p8c].join('\n\n');
